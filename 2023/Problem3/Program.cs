...
const string EXAMPLE_SCHEMATIC = @"
467..114..
...*......
..35..633.
......#...
...
var matrix = MatrixHelper.GetMatrix(SCHEMATIC);

//Console.WriteLine("PART 1!!!");

//var part1Result = new List<int>();

//for (var lineIndex = 0; lineIndex < matrix.GetLength(0); lineIndex++)
//{
//    string numericValueString = string.Empty;
//    bool touchesSymbol = false;

//    for (var columnIndex = 0; columnIndex < matrix.GetLength(1); columnIndex++)
//    {
//        var item = matrix[lineIndex, columnIndex];

//        if (char.IsNumber(item))
//        {
//            numericValueString += item.ToString();

//            if (!touchesSymbol)
//            {
//                var nearbyValues = MatrixHelper.GetNearbyValues(matrix, lineIndex, columnIndex);
//                touchesSymbol = MatrixHelper.IsAdjacentToSymbol(nearbyValues);
//            }
//        }

//        var numberIsComplete = columnIndex == matrix.GetLength(1) - 1
//            || !char.IsNumber(matrix[lineIndex, columnIndex + 1]);

//        if (numberIsComplete &&
//            touchesSymbol
//            && int.TryParse(numericValueString, out var value))
//        {
//            part1Result.Add(value);
//        }

//        if (numberIsComplete)
//        {
//            touchesSymbol = false;
//            numericValueString = string.Empty;
//        }
//    }
//}

//Console.WriteLine($"Sum: {part1Result.Sum()}");

Console.WriteLine();
Console.WriteLine("PART 2!!!");

var numbersList = new List<(int Number, List<Point> Stars)>();
...
for (var lineIndex = 0; lineIndex < matrix.GetLength(0); lineIndex++)
{
    ...
    for (var columnIndex = 0; columnIndex < matrix.GetLength(1); columnIndex++)
    {
        ...
        {
            numericValueString += item.ToString();
            stars.AddRange(MatrixHelper.GetAdjacentStarPoint(matrix, lineIndex, columnIndex));
        }
        ...
        if (numberIsComplete
            ...
            && stars.Count != 0)
        {
            numbersList.Add((value, stars.Distinct().ToList()));
        }
...
foreach (var (Number1, Stars1) in numbersList)
{
    foreach (var (Number2, Stars2) in numbersList)
    {
        if (Number1 != Number2
            && Stars1.Any(Stars2.Contains)
            && !gears.Contains(Number1 * Number2))
        {
            gears.Add(Number1 * Number2);
        }
    }
}
